					...
					<div class="row">
						<div class="col-md-8">
							<div class="form-group">
								...
								<input type="text" name="name" class="form-control input-bordered" value="{{old('name')}}" placeholder="Enter name...">
							</div>

							<div class="form-group">
								<label for="designation">Designation (required)</label>
								<input type="text" name="designation" class="form-control input-bordered" value="{{old('designation')}}" placeholder="Enter designation...">
							</div>
							
							<div class="form-group">
								<label>Quote</label>
								<textarea class="form-control" name="quote" id="editor" rows="3" placeholder="Enter your Quote...">{{old('quote')}}</textarea>
							</div>
						</div>
						<div class="col-md-4">
